...
export default function FileForm(props: FileFormChildfulProps) {
  ...
  const {register, handleSubmit, setValue, setError, watch, formState: {errors}} = useForm<FileProp>({
    defaultValues: {
  ...
  const current_files = watch();
  // console.log("Form errors:", errors); // Add in render
  // console.log("Form values:", current_files);
